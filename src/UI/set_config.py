...
class SetConfig(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setFixedSize(440, 410)  # 调整窗口尺寸，适应右侧对齐后的布局
        ...
        self.network_settings_label.setGeometry(QtCore.QRect(10, 75, 100, 20))
        ...
        self.speed_limit_desc_label.setGeometry(QtCore.QRect(10, 100, 60, 30))
        ...
        self.speed_limit.setGeometry(QtCore.QRect(75, 100, 60, 30))
        ...
        self.speed_limit_label.setGeometry(QtCore.QRect(140, 100, 40, 30))
        ...
        self.download_source_label.setGeometry(QtCore.QRect(200, 100, 60, 30))
        ...
        self.file_download_source.setGeometry(QtCore.QRect(320, 100, 100, 30))
        ...
        self.open_proxy.setGeometry(QtCore.QRect(10, 140, 100, 30))
        ...
        self.set_proxy_type.setGeometry(QtCore.QRect(105, 140, 75, 30))
        ...
        self.proxy_address.setGeometry(QtCore.QRect(185, 140, 120, 30))
        ...
        self.proxy_port.setGeometry(QtCore.QRect(345, 140, 75, 30))
        ...
        self.login_label.setGeometry(QtCore.QRect(10, 185, 100, 20))
        self.login_label.setStyleSheet('font-weight: bold; color: #2c3e50;')

        # 第二行：用户名和密码 - 增加间距
        self.user_name = QLineEdit(self.centralwidget)
        self.user_name.setGeometry(QtCore.QRect(10, 210, 140, 30))
        ...
        self.password.setGeometry(QtCore.QRect(160, 210, 140, 30))
        ...
        self.user_conf_save_button.setGeometry(QtCore.QRect(350, 210, 70, 30))
        self.user_conf_save_button.clicked.connect(self.save_user)

        # 下载设置区域
        self.download_settings_label = QLabel('下载设置:', self.centralwidget)
        self.download_settings_label.setGeometry(QtCore.QRect(10, 250, 100, 20))
        ...
        self.label.setGeometry(QtCore.QRect(10, 275, 90, 30))
        self.label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)

        # 第三行：最大重试次数和超时时间 - 增加间距
        self.max_retries_desc_label = QLabel('重试次数:', self.centralwidget)
        self.max_retries_desc_label.setGeometry(QtCore.QRect(215, 250, 60, 20))
        ...
        self.max_retries.setGeometry(QtCore.QRect(215, 275, 60, 30))
        ...
        self.max_retries_label.setGeometry(QtCore.QRect(280, 275, 30, 30))
        ...
        self.timeout_desc_label.setGeometry(QtCore.QRect(315, 250, 60, 20))
        self.timeout_desc_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)

        self.timeout = QLineEdit(self.centralwidget)
        self.timeout.setGeometry(QtCore.QRect(315, 275, 50, 30))
        ...
        self.time_out_label.setGeometry(QtCore.QRect(390, 275, 30, 30))
        ...
        self.folder_name_type_combo_box.setGeometry(QtCore.QRect(105, 275, 100, 30))
        ...
        self.file_types_label.setGeometry(QtCore.QRect(10, 315, 100, 20))
        self.file_types_label.setStyleSheet('font-weight: bold; color: #2c3e50;')

        # 第六行和第七行：文件类型选择 - 增加间距
        self.checkbox_MP3 = QCheckBox("MP3", self.centralwidget)
        self.checkbox_MP3.setGeometry(QtCore.QRect(10, 340, 60, 30))
        ...
        self.checkbox_MP4.setGeometry(QtCore.QRect(80, 340, 60, 30))
        ...
        self.checkbox_FLAC.setGeometry(QtCore.QRect(150, 340, 60, 30))
        ...
        self.checkbox_WAV.setGeometry(QtCore.QRect(220, 340, 60, 30))
        ...
        self.checkbox_JPG.setGeometry(QtCore.QRect(290, 340, 60, 30))
        ...
        self.checkbox_PNG.setGeometry(QtCore.QRect(360, 340, 60, 30))
        ...
        self.checkbox_PDF.setGeometry(QtCore.QRect(10, 370, 60, 30))
        ...
        self.checkbox_TXT.setGeometry(QtCore.QRect(80, 370, 60, 30))
        ...
        self.checkbox_VTT.setGeometry(QtCore.QRect(150, 370, 60, 30))
        ...
        self.checkbox_LRC.setGeometry(QtCore.QRect(220, 370, 60, 30))
